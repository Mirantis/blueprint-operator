...
func TestInstallAddons_MultipleAddonsWithSameChart(t *testing.T) {
	...
	a1 := metav1.ObjectMeta{Name: "same-chart-1", Namespace: consts.NamespaceBlueprintSystem}
	a2 := metav1.ObjectMeta{Name: "same-chart-2", Namespace: consts.NamespaceBlueprintSystem}
